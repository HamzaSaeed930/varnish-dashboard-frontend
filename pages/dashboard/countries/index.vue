    ...
    <div class="space-y-8 sm:space-y-4">
      ...
      >
        <div class="flex flex-col items-center gap-3">
          <div
            class="w-8 h-8 border-4 border-gray-300 dark:border-gray-600 border-t-black dark:border-t-white rounded-full animate-spin"
          ></div>
...
// Set page title
useHead({
  title: "Countries - Varnish Dashboard",
});
...
const getLogoUrl = (logoUrl: string) => {
  ...
  return `${config.public.NUXT_PUBLIC_API_BASE_URL}${logoUrl}`;
};
